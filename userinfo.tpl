	...
	<table class="user-info-table">
		<tr>
			...
			<td>
				...
				<br /><br />Количество публикаций: [declination={news-num}]публикаци|я|и|й[/declination]
				<br /><br />Количество комментариев: [declination={comm-num}]комментари|й|я|ев[/declination]
